...
('Alice Johnson', 'alice@tutora.com', 'student'),
('Bob Smith', 'bob@tutora.com', 'tutor'),
('Charlie Brown', 'charlie@tutora.com', 'tutor')
...
FROM tutora_app.users
WHERE email = 'charlie@tutora.com'
ON CONFLICT DO NOTHING;
